CREATE TABLE MY_DISPLAY_SERVICE_PACKAGE(
...
INSERT INTO MY_DISPLAY_SERVICE_PACKAGE (id, name, description, gender, icon) VALUES
...
(6,  'beauté des mains', 'description', 'f', '/icons/6.png'),
(7,  'beauté des pieds', 'description', 'f', '/icons/7.png'),
